...
![Design preview for the Clock app coding challenge](clock-app/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](clock-app/README-template.md) file in this starter code.
